...
@section('main-content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Add a new Task/</span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="task_name"
                                    placeholder="Task Name" name="name" value="{{old('name')}}" />
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="task_detail"
                                    placeholder="Task Details" name="details" value="{{old('details')}}" ></textarea>
                                @error('details')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="checkbox" id="iscomplete"
                                 name="isComplete" value="completed" > </input>
